...
- Producción: Bajo demanda. Sin inventario físico. Se fabrica después del pago.
- Tiempo de fabricación: 5 días hábiles
- Envío: Tiempo adicional según ciudad. Inicial solo Colombia.
- Cobertura actual: Todo Colombia
- Cobertura futura: Internacional
- Envío gratis: Compras superiores a $300.000 COP (equivalente a ~2 bikinis)
- Flujo de compra: Selección → Pago anticipado → Cola de producción (5 días) → Envío
- Imágenes iniciales: Generadas con IA (Google Flow / Nano Banana Pro). Sirven como guía para artesanas y mockups web. Se reemplazan/combinan con fotos reales en fases posteriores.
- Canal de atención principal: WhatsApp Business (canal #1 de ventas en Colombia)
